...
struct JavaScriptCodableAnyTests {
  ...
  @Test
  func `decodes null and undefined as NSNull`() throws {
    #expect(try JavaScriptValue.decodeAny(runtime.eval("null"), in: runtime) is NSNull)
    #expect(try JavaScriptValue.decodeAny(runtime.eval("undefined"), in: runtime) is NSNull)
  }
